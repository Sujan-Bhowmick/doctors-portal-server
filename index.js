...
async function run() {
  try {
    ...
    app.put('/user/admin/:email', veryfyJWT, veryfyAdmin, async (req, res) => {
      const email = req.params.email;
    ...
    */
    ...
    app.get('/booking/:id', veryfyJWT, async(req, res) => {
    ...
    app.patch('/booking/:id', veryfyJWT, async(req, res) => {
      const id = req.params.id;
    ...
    app.get('/doctor', veryfyJWT, veryfyAdmin, async (req, res) => {
      const doctors = await doctorsCollection.find().toArray();
      res.send(doctors);
    })

    app.post('/doctor', veryfyJWT, veryfyAdmin, async (req, res) => {
      const doctor = req.body;
      const result = await doctorsCollection.insertOne(doctor);
      res.send(result);
    });

    app.delete('/doctor/:email', veryfyJWT, veryfyAdmin, async (req, res) => {
      const email = req.params.email;
      const filter = { email: email };
...
app.get('/', (req, res) => {
  res.send('Hello From Doctors Uncle aunty!')
})
